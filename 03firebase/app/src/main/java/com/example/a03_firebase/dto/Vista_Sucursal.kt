...
class Vista_Sucursal : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val txtEmpresa = findViewById<TextView>(R.id.txt_NombreEmpresaSucur)
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            R.id.menu_editar -> {
                abrirActividadConParametros(nombreEmpresa, idEmpresa, tituloSucursalSeleccionada,idSucursalSeleccionada, CrearEmpre::class.java)
                return true
            }
            R.id.menu_eliminar -> {
    ...
    private fun abrirUbicacion(latitud:Double, longitud: Double, nombre:String, clase: Class<*>) {
    ...
    private fun abrirActividadConParametros(empresa: String, idiEmpresa: String, nombreSucursal: String, idSucursal:String, clase: Class<*>) {
        val intentExplicito = Intent(this, clase)
        intentExplicito.putExtra("nombreEmpresa", empresa)
        intentExplicito.putExtra("idEmpresa", idiEmpresa)
        intentExplicito.putExtra("idSucursal", idSucursal)
        intentExplicito.putExtra("nombreSucursal", nombreSucursal)
        startActivity(intentExplicito)
    }
}